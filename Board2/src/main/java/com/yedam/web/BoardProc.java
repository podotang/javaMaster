...
import com.yedam.dao.CommentsDAO;
...
public class BoardProc {
	...
	public void boardList() {
		...
		while (true) {
			...
			System.out.println("--------------------------------------------------------------------");
			List<BoardVO> InfoList = bdao.boardList();
	...
	public void boardDetail(int selectedBoardNo) {
		BoardVO selectedBoard = bdao.boardInfo(selectedBoardNo);
		boolean run = true;
		while (run) {
			if (selectedBoard != null) {
				...
				System.out.println("작성일: " + selectedBoard.getDate());
				System.out.println("--------------------------------------------------------------------");
				System.out.println("<댓글>");
				System.out.println("====================================================================");
				System.out.println("댓글번호	  내용	  	 	 글쓴이			작성일");

				List<CommentsVO> clist = cdao.commentList(selectedBoardNo);
	...
	public void boardUpdate() {
		...
		sc.nextLine();
		BoardVO board = bdao.boardInfo(chooseNum);
	...
	public void boardDelete() {
		...
		sc.nextLine();
//		board = new Board();
		BoardVO board = bdao.boardInfo(boardNum);
